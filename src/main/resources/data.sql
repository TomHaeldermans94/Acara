...
insert into user values (1,'adminFirst','adminLast','$2y$10$14ux7BShikxkMJ2.qVyXOOIur8Q0Br58RzfdxYpC9k5DqEXqzEdx.','admin'); /* admin admin */
insert into user values (2,'Ruben','Neven','$2y$10$7D8fk.KuQGuTjxsYOcAnUePD.eph.fSJyGOOZ3DJuNy0l2OBL39JS','ruben'); /* ruben rubenpw */
insert into user values (3,'Tom','Haeldermans','$2y$10$r9vGBv4yyCGlr6mhfENLf.QVaPiPtKf2CL2aQhsFe2KIZ6TqV.CKe','tom'); /* tom tompw */
insert into user values (4,'Michiel','Thomassen','$2a$09$NXc2Hlu9ng/rcjMHa4ggZO5J6ZXjZHtQZC4Ar360cJNIMVSW28K42','michiel');  /* michiel michielpw */
insert into user values (5,'test','test','$2y$10$mUDfNQFM4HXQzgW98NXD6eS.CxHjVkRq2E20ZT.0YM2zJu1AsJblm','test');  /* test test */
