...
class EventServiceUnitTest {
    ...
    void addEvent_withNullYoutubeUrl() {
        Event event = firstEvent();
        event.setId(null);
        assertThrows (InvalidYoutubeUrlException.class, () -> event.setYoutubeId(null));
    }
    ...
    void addEvent_withInvalidYoutubeUrl() {
        Event event = firstEvent();
        event.setId(null);
        assertThrows (InvalidYoutubeUrlException.class, () -> event.setYoutubeId("youtube.com/watch?=hdhdjdhe{{{{{"));
    }
